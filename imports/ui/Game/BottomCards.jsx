    ...
    return (
        <Bottom>
            <div className="secondRow">
                ...
                <span>{player.first.length === 2 ? <Button disabled={followsuit(player, player.first[0])} onClick={() => handlePlayCard(player, player.first[0], 'first')}>{renderCard("FD", 99)}</Button> : null}</span>
                ...
                <span>{player.second.length === 2 ? <Button disabled={followsuit(player, player.first[0])} onClick={() => handlePlayCard(player, player.first[0], 'first')}>{renderCard("FD", 99)}</Button> : null}</span>
                ...
                <span>{player.third.length === 2 ? <Button disabled={followsuit(player, player.first[0])} onClick={() => handlePlayCard(player, player.first[0], 'first')}>{renderCard("FD", 99)}</Button> : null}</span>
            </div>
